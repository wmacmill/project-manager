...
class Shortcode_Tinymce
{
    ...
    public function bboss_shortcodes_dialog() {
        ...
        wp_enqueue_style('admin-style', get_template_directory_uri() . '/buddyboss-inc/buddyboss-shortcodes/admin/admin-style.css');
                            ...
                            <div class="option ">
                                ...
                                <div class="controls with-desc">
                                    <select class="select input"  id="tabs-style">
                                      <option id="default" value="default"><?php _e('Default','buddyboss-creative-theme' ); ?></option>
                                      <option id="wide" value="long"><?php _e('Long','buddyboss-creative-theme' ); ?></option>
                                    </select>
                                </div>
                            </div>
                        </div>  
