			...
			$this->sections[] = array(
				...
				'fields'	 => array(
					...
					array(
						...
						'subtitle'	 => __( 'The mobile titlebar can optionally dislplay a search input in place of your site logo/title.', 'boss' ),
						'on'		 => __( 'Display', 'boss' ),
						'off'		 => __( 'Hide', 'boss' ),
						'default'	 => '0',
					),
			...
			$this->sections[] = array(
				...
				'fields'	 => array(
					array(
						...
						'subtitle'	 => __( 'Unlimited slides with drag and drop sortings. Ideal image size is 1040px by 400px.', 'boss' ),
						'default'	 => '1',
						'on'		 => __( 'On', 'boss' ),
						'off'		 => __( 'Off', 'boss' ),
					),
