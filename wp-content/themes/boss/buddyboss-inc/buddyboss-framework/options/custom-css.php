...
if ( !function_exists( 'boss_generate_option_css' ) ) {
	...
	function boss_generate_option_css() {
		...
		.page-template-page-no-buddypanel .header-inner <?php echo $header_menu_class; ?>  a,
		.page-template-page-no-buddypanel .header-inner <?php echo $header_menu_class; ?>  a:hover {
