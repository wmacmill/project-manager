...
(function( $ ) {
    ...
    $.redux.initEvents = function() {
        ...
        $( '.redux-action_bar input' ).on(
            'click', function( e ) {
				var parentElem = jQuery( '.redux-main' );
                if ( $( this ).attr( 'name' ) == redux.args.opt_name + '[defaults]' ) {
					...
					if ( parentElem.find( '.bb-confirm-dialog-wrapper' ).length === 0 ) {
						parentElem.append( '<div class="bb-confirm-dialog-wrapper"><div class="bb-confirm-dialog-overlay"></div><div class="bb-confirm-dialog">' + redux.args.reset_confirm + '<div class="bb-button-wrap"><button class="bb-confirm button button-primary" type="button" data-action="confirm">Yes</button><button class="bb-cancel button" type="button" data-action="cancel">Cancel</button></div></div></div>' );
					}
					e.preventDefault();
					$( document ).on( 'click', '.bb-button-wrap .button', function () {
						...
						if ( action === 'confirm' ) {
							...
							if ( redux.args.ajax_save === true ) {
								$.redux.ajax_save( $( '#redux-defaults' ) );
								e.preventDefault();
							}
						} else {
							return false;
					...
					if ( parentElem.find( '.bb-confirm-dialog-wrapper' ).length === 0 ) {
						parentElem.append( '<div class="bb-confirm-dialog-wrapper"><div class="bb-confirm-dialog-overlay"></div><div class="bb-confirm-dialog">' + redux.args.reset_section_confirm + '<div class="bb-button-wrap"><button class="bb-confirm button button-primary" type="button" data-action="confirm">Yes</button><button class="bb-cancel button" type="button" data-action="cancel">Cancel</button></div></div></div>' );
					}
					e.preventDefault();
					$( document ).on( 'click', '.bb-button-wrap .button', function () {
						...
						if ( action === 'confirm' ) {
							...
							if ( redux.args.ajax_save === true ) {
								$.redux.ajax_save( $( '#redux-defaults-section' ) );
								e.preventDefault();
							}
						} else {
							return false;
