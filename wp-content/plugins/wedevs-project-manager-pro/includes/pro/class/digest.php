...
class CPM_Pro_Digest {
    ...
    function table_start() {
        ...
        <div style="width: 600px; padding: 20px; border: 1px solid #eee; margin: 0 auto; background-color: #fff;">
            <table width="100%" bgcolor="#fff" style="border-collapse: collapse; border: none;">
                ...
                <tr>
                    <td style="font-size: 11px; color: #9d9d9d; padding: 0;"><?php _e( 'Project items Dues or added or completed in the last 24 hours', 'cpm' ); ?></td>
                </tr>
        <?php
    }
    ...
    function render_task_html( $task, $status = 0 ) {
        ...
        ?>
            <tr>
                <td style="padding-left: 20px; border-top: 0; border-bottom: 0;"><?php $this->complete_task_html( $task, $imgurl ); ?></td>
            </tr>
        <?php
    }
    /**
