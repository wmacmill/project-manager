...
window.dhtmlx || (dhtmlx = function(t) {
    ...
    function() {
            ...
            if (this.isTaskExists(d) || (d = t.lastTaskOfLevel(l.$level), d == t.config.id && (d = null)), this.isTaskExists(d)) {
                ...
                if (_.y + o.offsetHeight / 2 < r) {
                    ...
                    if (g) {
                        if (g.id == l.id) return;
                        h = g
                    } else if (g = this._pull[this._order[c]], g.$level == l.$level) return this.moveTask(l.id, -1, g.parent), void(i.target = "next:" + g.id)
                }
            ...
            if (2 != t.button && !gantt.config.readonly && !this.drag.mode) {
                ...
                if (i)
                    if (i.mode && i.mode != gantt.config.drag_mode.ignore && gantt.config["drag_" + i.mode]) {
                        ...
                        if (gantt._is_flex_task(s) && i.mode != gantt.config.drag_mode.progress) return void this.clear_drag_state();
                        i.id = a;
        ...
        this._lightbox_id == t && (this._lightbox_id = e), this._selected_task == t && (this._selected_task = e), this._tasks_dnd.drag && this._tasks_dnd.drag.id == t && (this._tasks_dnd.drag.id = e)
                ...
                switch (l) {
                    ...
                    case "%H:%i":
                        ...
                        for (t._time_values = []; s > c;) {
                            ...
                            _ += "<option value='" + c + "'>" + u + "</option>", t._time_values.push(c), a.setTime(a.valueOf() + 60 * this._get_timepicker_step() * 1e3);
                            var f = a.getDate() != g ? 1 : 0;
                            c = 24 * f * 60 + 60 * a.getHours() + a.getMinutes()
                        }
                }
                if (_) {
    ...
    function() {
        ...
        this._gantt_touch_event_ready || (this._gantt_touch_event_ready = 1, dhtmlxEvent(document.body, t[0], function(t) {
            ...
            if (!n(t)) {
                if (t.touches && t.touches.length > 1) return void(r = !1);
                if (r = !0, d = e(t), d && s) {
                    var a = new Date;
